...
import { getRecords, getEvents, getSwimmers, getCompetitionInfo } from '../services/databaseService';
    ...
    useEffect(() => {
        const fetchDataAndSubscribe = async () => {
            ...
            const [eventsData, swimmersData, infoData, recordsData] = await Promise.all([
                getEvents(), getSwimmers(), getCompetitionInfo(), getRecords()
            ]);
